 ...
 */
?>
<h4 style="border-bottom: 1px dotted #D3D3D3;margin-bottom: 30px;">基本信息 <b style="color: #a9a9a9;font-size: 80%;">(*号为必填项)</b></h4>
    ...
    <form action="" method="post" name="basic_profile_frm" id="basic_profile_frm">
        <table border="0" class="basic_profile_tb">
            <tr>
                ...
                <td><input type="text" name="nickname" value="<?php echo $user_info->nickname;?>"/><br /></td>
            </tr>
            <tr>
